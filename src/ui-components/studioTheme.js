...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(249, 60%, 75%)" },
          20: { value: "hsl(249, 60%, 66%)" },
          40: { value: "hsl(249, 53%, 57%)" },
          60: { value: "hsl(249, 48%, 49%)" },
          80: { value: "hsl(249, 55%, 42%)" },
          90: { value: "hsl(249, 63%, 35%)" },
          100: { value: "hsl(249, 68%, 29%)" },
        },
        secondary: {
          10: { value: "hsl(0, 36%, 95%)" },
          20: { value: "hsl(0, 74%, 95%)" },
          40: { value: "hsl(0, 71%, 93%)" },
          60: { value: "hsl(0, 100%, 93%)" },
          80: { value: "hsl(0, 100%, 92%)" },
          90: { value: "hsl(0, 83%, 88%)" },
          100: { value: "hsl(0, 76%, 85%)" },
        },
      },
      font: {
        ...
        interactive: { value: "{colors.brand.primary.100.value}" },
        hover: { value: "{colors.brand.primary.100.value}" },
